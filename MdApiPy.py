...
if sys.platform == 'win32':
    ...
    # from ctp_win64.ctpwrapper.MdApi import MdApiWrapper
    # from ctp_win64.ctpwrapper import ApiStructure
elif sys.platform == 'linux':
    from ctp_linux64.ctpwrapper.MdApi import MdApiWrapper
...
class MdApiPy(MdApiWrapper):
    ...
    def OnFrontDisconnected(self, nReason):
        ...
        print('onFrontDisConnected, nReason = %d' % nReason)
    ...
    def OnHeartBeatWarning(self, nTimeLapse):
        ...
        print('OnHeartBeatWarning, nTimeLapse = %s' % nTimeLapse)
